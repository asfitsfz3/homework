            ...
            <div class="content-middle">
                ...
                <div class="content-main__container">
                    <div class="cart-product-list">
                        @foreach ($arr['my_goods'] as $value)


                        <div class="cart-product-list__item">
                            <div class="cart-product__item__product-photo"><img src="img/cover/{{ $value['photo_id'] }}" class="cart-product__item__product-photo__image"></div>
                            <div class="cart-product__item__product-name">
                                <div class="cart-product__item__product-name__content"><a href="#">{{ $value['name'] }}</a></div>
                            </div>
                            <div class="cart-product__item__cart-date">
                            </div>
                            <div class="cart-product__item__product-price"><span class="product-price__value">{{ $value['price'] }}</span></div>
                        </div>
